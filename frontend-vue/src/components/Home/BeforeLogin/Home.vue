<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-indigo-900 text-gray-100 py-12 px-4 sm:px-8 relative overflow-hidden">
    ...
    <div class="flex flex-col items-center justify-center min-h-[90vh] relative z-10 space-y-8">
      <div class="relative">
        <div class="w-48 h-48 rounded-full bg-gradient-to-br from-green-600 to-blue-700 animate-breathing shadow-2xl"></div>
        <div class="absolute inset-4 rounded-full overflow-hidden border-4 border-gray-800">
          <img
            src="/logo.png"
      ...
      <h1 class="sm:text-6xl text-4xl font-extrabold text-gray-100 tracking-wide leading-tight">
        <span class="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-blue-400 to-indigo-400">
          Touch-Grass Challenge
        </span>
      </h1>
      
      <p class="sm:text-2xl text-xl max-w-2xl mx-auto text-gray-300 leading-relaxed font-light">
        Daily reminder to embrace things that are 
        <span class="font-medium text-green-400 relative px-1">
          real
          <span class="absolute bottom-0 left-0 w-full h-1 bg-green-700 rounded-full"></span>
        </span>
      </p>
      
      
      <div class="flex flex-col sm:flex-row gap-4 mt-8">
        <button @click="handleGetStarted" class="bg-gradient-to-r from-green-600 to-blue-600 text-white
